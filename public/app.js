    ...
    dreamsContainer.innerHTML = dreams.map(dream => {
        ...
        <div class="dream-card" data-id="${dream.id}">
            ...
            <div class="interpretation">
                ...
                ${shouldTruncate ? `<button class="read-more-btn" onclick="toggleInterpretation(event)">Read More</button>` : ''}
            </div>
        </div>
    `;
    }).join('');
...
async function deleteDream(id) {
    ...
    try {
        ...
        console.error('Error:', error);
        console.log('Failed to delete dream. Please try again.');
    }
}
...
function showErrorMessage(message) {
    ...
    errorContainer.innerHTML = `
        <div class="error-alert">
            ...
            <button class="close-error" onclick="clearErrorMessage()">×</button>
        </div>
    `;
